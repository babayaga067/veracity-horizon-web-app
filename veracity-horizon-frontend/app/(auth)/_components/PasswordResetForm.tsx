...
import { z } from "zod";
import { handleResetPassword } from "@/app/lib/actions/auth-actions";
  ...
  return (
    <div>
      <form className="max-w-md" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mb-4">
          <Link href="/login" className="text-sm text-blue-500 hover:underline mb-4 inline-block">Back to Login</Link>
          <Link href="/forgot-password" className="text-sm text-blue-500 hover:underline mb-4 inline-block ml-4">Request another reset email</Link>
        </div>
