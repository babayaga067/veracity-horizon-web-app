    ...
    <div className="w-full">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <button
              ...
              disabled={isPending || isSubmitting}
              className="absolute right-3 top-1/2 -translate-y-1/2 p-2 text-slate-400 hover:text-slate-700 focus:outline-none rounded-lg transition-colors"
        ...
        <button
          ...
          className="btn-primary w-full flex items-center justify-center py-3.5 px-4 text-base font-bold rounded-xl disabled:opacity-60 disabled:cursor-not-allowed transition-all mt-4"
        >
