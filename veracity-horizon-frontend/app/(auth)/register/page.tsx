  ...
  return (
    <div className="min-h-screen w-full flex font-sans antialiased animated-gradient">
      ...
      <div className="hidden lg:flex lg:w-5/12 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 rounded-full bg-violet-400 blur-3xl opacity-20 z-0 float"></div>
        <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 rounded-full bg-indigo-500 blur-3xl opacity-20 z-0 float-delayed"></div>
        ...
        <div className="relative z-10 max-w-lg mt-auto mb-auto">
          <span className="inline-block py-1 px-3 rounded-full bg-white/10 text-violet-200 text-xs font-semibold tracking-wider uppercase mb-6 border border-white/20">
            Bidder Registration
          </span>
