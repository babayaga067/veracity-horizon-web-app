...
export default function AdminSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-72 bg-gradient-to-b from-slate-900 via-slate-950 to-slate-900 text-white z-50 flex flex-col shadow-2xl">
      <div className="p-6 border-b border-slate-800">
        <Link href="/admin/auctions" className="flex items-center gap-4">
          ...
          <div>
            <p className="font-bold text-white text-xl">Admin</p>
        ...
        <div className="mt-4 pt-4 border-t border-slate-800">
          <div className="flex items-center gap-3 px-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <span className="inline-block px-2 py-0.5 text-xs font-bold uppercase rounded-full bg-blue-500/20 text-blue-300 mt-1">
                {user?.role}
              </span>
            </div>
          </div>
